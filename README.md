...
For this, we reconstituted the filament network on model membranes and imaged with atomic force microscopy (AFM) and negative stain electron microscopy (nsEM).
...
## Purpose:
For this theis we needed to quantifying filament network structure from AFM/nsEM images. For this, we extracted filament positions, measuring local order (spacing and angles between filaments), and distinguishing locally ordered clusters from globally disordered regions.
